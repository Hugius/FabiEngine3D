...
void AnimationEditor::initializeGUI()
{
	...
	leftWindow->getScreen("animationEditorMenuFrame")->addButton("translation", Vec2(0.0f, 0.7f), Vec2(GW("Translation"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Translation", LVPC::textColor, LVPC::textHoverColor);
	leftWindow->getScreen("animationEditorMenuFrame")->addButton("rotation", Vec2(0.0f, 0.35f), Vec2(GW("Rotation"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Rotation", LVPC::textColor, LVPC::textHoverColor);
	leftWindow->getScreen("animationEditorMenuFrame")->addButton("scaling", Vec2(0.0f, 0.0f), Vec2(GW("Scaling"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Scaling", LVPC::textColor, LVPC::textHoverColor);
