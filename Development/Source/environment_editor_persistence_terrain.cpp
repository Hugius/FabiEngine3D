	...
	if (_fe3d.misc_isFileExisting(filePath))
	{
		...
		while (std::getline(file, line))
		{
			...
			if (heightMapPath != "")
			{
				...
				_fe3d.terrainEntity_setNormalMappedR(terrainID, isNormalMapped);
				_fe3d.terrainEntity_setNormalMappedG(terrainID, isNormalMapped);
				_fe3d.terrainEntity_setNormalMappedB(terrainID, isNormalMapped);
				...
				if (normalMapPathR != "")  _fe3d.terrainEntity_setNormalMapR(terrainID, normalMapPath);
				if (normalMapPathG != "")  _fe3d.terrainEntity_setNormalMapG(terrainID, normalMapPath);
				if (normalMapPathB != "")  _fe3d.terrainEntity_setNormalMapB(terrainID, normalMapPath);
