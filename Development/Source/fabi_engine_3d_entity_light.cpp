...
void FabiEngine3D::lightEntity_add(const string& ID, Vec3 position, Vec3 radius, Vec3 color, float intensity, bool isVisible)
{
	_core->_lightEntityManager.addLightEntity(ID, position, radius, color, intensity);
