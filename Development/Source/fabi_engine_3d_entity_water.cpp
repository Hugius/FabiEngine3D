...
{
	_core->_waterEntityManager.getEntity(ID)->setDudvMap(_core->_textureLoader.getTexture(texturePath, false, false));
...
{
	_core->_waterEntityManager.getEntity(ID)->setNormalMap(_core->_textureLoader.getTexture(texturePath, false, false));
...
{
	_core->_waterEntityManager.getEntity(ID)->setDisplacementMap(_core->_textureLoader.getTexture(texturePath, false, false));
