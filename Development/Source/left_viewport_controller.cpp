...
void LeftViewportController::initialize()
{
	...
	_gui->getViewport("left")->getWindow("main")->getScreen("main")->addButton("billboardEditor", vec2(0.0f, 0.0f), vec2(1.8f, 0.1f), _gui->leftVpButtonColor, _gui->leftVpButtonHoverColor, "Billboard editor", _gui->leftVpTextColor, _gui->leftVpTextHoverColor);
