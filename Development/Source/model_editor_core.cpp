...
void ModelEditor::initializeGUI()
{
	...
	_leftWindow->getScreen("modelEditorMenuOptions")->addButton("isFaceculled", vec2(0.0f, 0.7f), vec2(GW("Culling: OFF"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Culling: OFF", LVPC::textColor, LVPC::textHoverColor);
	_leftWindow->getScreen("modelEditorMenuOptions")->addButton("isTransparent", vec2(0.0f, 0.35f), vec2(GW("Alpha: OFF"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Alpha: OFF", LVPC::textColor, LVPC::textHoverColor);
	_leftWindow->getScreen("modelEditorMenuOptions")->addButton("setColor", vec2(0.0f, 0.0f), vec2(GW("Set color"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Set color", LVPC::textColor, LVPC::textHoverColor);
	_leftWindow->getScreen("modelEditorMenuOptions")->addButton("uvRepeat", vec2(0.0f, -0.35f), vec2(GW("Set UV-repeat"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Set UV-repeat", LVPC::textColor, LVPC::textHoverColor);
	_leftWindow->getScreen("modelEditorMenuOptions")->addButton("back", vec2(0.0f, -0.7f), vec2(GW("Go back"), 0.1f), LVPC::buttonColor, LVPC::buttonHoverColor, "Go back", LVPC::textColor, LVPC::textHoverColor);
