...
void RightViewportController::initialize()
{
	...
	rightWindow->getScreen("skyEditorControls")->createTextField("mouse", Vec2(-0.5f, 0.475f), Vec2(TW("Move Camera"), CH), "Move Camera", BLACK, false);
	rightWindow->getScreen("skyEditorControls")->createTextField("h", Vec2(-0.5f, 0.275f), Vec2(TW("Debug Render"), CH), "Debug Render", BLACK, false);
	rightWindow->getScreen("skyEditorControls")->createTextField("f", Vec2(-0.5f, 0.075f), Vec2(TW("Wire Frame"), CH), "Wire Frame", BLACK, false);
	rightWindow->getScreen("skyEditorControls")->createTextField("esc", Vec2(-0.5f, -0.125f), Vec2(TW("Back"), CH), "Back", BLACK, false);
