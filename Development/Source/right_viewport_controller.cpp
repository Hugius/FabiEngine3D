...
void RightViewportController::initialize()
{
	...
	sceneEditorScreen->addTextfield("wasd", Vec2(-0.7f, -0.67f), Vec2(CW("XZ movement"), textHeight), "XZ movement", black, false);
	...
	animationEditorScreen->addTextfield("title", Vec2(0.0f, 0.9f), Vec2(CW("Animation Editor"), textHeight), "Animation Editor", white);
	animationEditorScreen->addTextfield("mouse", Vec2(-0.5f, 0.675f), Vec2(CW("Move cam"), textHeight), "Move cam", black, false);
	animationEditorScreen->addTextfield("h", Vec2(-0.5f, 0.475f), Vec2(CW("Debug render"), textHeight), "Debug render", black, false);
	...
	scriptEditorScreen->addTextfield("title", Vec2(0.0f, 0.9f), Vec2(CW("Script Editor"), textHeight), "Script Editor", white);
	...
	scriptEditorScreen->addTextfield("ctrlC", Vec2(0.0f, -0.625f), Vec2(CW("Copy"), textHeight), "Copy", black, false);
