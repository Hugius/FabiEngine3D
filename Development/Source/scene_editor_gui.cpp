...
void SceneEditor::_loadGUI()
{
	...
	leftWindow->getScreen("sceneEditorMenuMain")->createButton("add", Vec2(0.0f, positions[0]), Vec2(TW("Add Scene"), CH), LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, "Add Scene", LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR);
	...
	leftWindow->getScreen("sceneEditorMenuSoundPlace")->createScrollingList("soundcasters", Vec2(0.0f, 0.1f), Vec2(1.8f, 1.75f), LVPC::SCROLLING_LIST_COLOR, LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR, Vec2(0.15f, 0.1f));
	...
	leftWindow->getScreen("sceneEditorMenuSoundChoice")->createScrollingList("soundcasters", Vec2(0.0f, 0.1f), Vec2(1.8f, 1.75f), LVPC::SCROLLING_LIST_COLOR, LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR, Vec2(0.15f, 0.1f));
	...
	leftWindow->getScreen("sceneEditorMenuLightingPoint")->createButton("add", Vec2(0.0f, positions[0]), Vec2(TW("Place Light"), CH), LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, "Place Light", LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR);
	...
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("radius", Vec2(0.0f, 0.55f), Vec2(0.75f, 0.2f), "radius.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("color", Vec2(0.0f, 0.3f), Vec2(0.75f, 0.2f), "color.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createTextfield("x", Vec2(0.0f, 0.135f), Vec2(0.25f, 0.1f), "X", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createTextfield("y", Vec2(0.0f, -0.115f), Vec2(0.25f, 0.1f), "Y", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createTextfield("z", Vec2(0.0f, -0.365f), Vec2(0.25f, 0.1f), "Z", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("xPlus", Vec2(0.75f, 0.025f), Vec2(0.5f, 0.15f), "plus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("yPlus", Vec2(0.75f, -0.225f), Vec2(0.5f, 0.15f), "plus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("zPlus", Vec2(0.75f, -0.475f), Vec2(0.5f, 0.15f), "plus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("xMinus", Vec2(-0.75f, 0.025f), Vec2(0.5f, 0.15f), "minus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("yMinus", Vec2(-0.75f, -0.225f), Vec2(0.5f, 0.15f), "minus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("zMinus", Vec2(-0.75f, -0.475f), Vec2(0.5f, 0.15f), "minus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createWritefield("x", Vec2(0.0f, 0.025f), Vec2(1.0f, 0.1f), Vec3(0.25f), Vec3(0.75f), Vec3(1.0f), Vec3(0.0f), 0, 1, 1, 1, 1);
	rightWindow->getScreen("pointLightPropertiesMenu")->createWritefield("y", Vec2(0.0f, -0.225f), Vec2(1.0f, 0.1f), Vec3(0.25f), Vec3(0.75f), Vec3(1.0f), Vec3(0.0f), 0, 1, 1, 1, 1);
	rightWindow->getScreen("pointLightPropertiesMenu")->createWritefield("z", Vec2(0.0f, -0.475f), Vec2(1.0f, 0.1f), Vec3(0.25f), Vec3(0.75f), Vec3(1.0f), Vec3(0.0f), 0, 1, 1, 1, 1);
	rightWindow->getScreen("pointLightPropertiesMenu")->createTextfield("intensity", Vec2(0.0f, -0.64f), Vec2(1.5f, 0.1f), "Intensity", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("intensityPlus", Vec2(0.75f, -0.75f), Vec2(0.5f, 0.15f), "plus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createButton("intensityMinus", Vec2(-0.75f, -0.75f), Vec2(0.5f, 0.15f), "minus.png", Vec3(1.0f));
	rightWindow->getScreen("pointLightPropertiesMenu")->createWritefield("intensity", Vec2(0.0f, -0.75f), Vec2(1.0f, 0.1f), Vec3(0.25f), Vec3(0.75f), Vec3(1.0f), Vec3(0.0f), 0, 1, 1, 1, 1);
	...
	rightWindow->getScreen("soundPropertiesMenu")->createTextfield("y", Vec2(0.0f, 0.55f), Vec2(0.25f, 0.1f), "Y", Vec3(1.0f));
	rightWindow->getScreen("soundPropertiesMenu")->createTextfield("z", Vec2(0.0f, 0.3f), Vec2(0.25f, 0.1f), "Z", Vec3(1.0f));
