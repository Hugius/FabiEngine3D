...
void ScriptEditor::_loadGUI()
{
	...
	leftWindow->getScreen("scriptEditorMenuMain")->createButton("add", Vec2(0.0f, positions[2]), Vec2(TW("Create Script"), CH), LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, "Create Script", LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR);
