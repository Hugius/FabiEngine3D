...
private:
	...
	bool _executeFe3dNetworkFunction(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	...
	bool _validateFe3dSoundEntity(const string& ID, bool previewEntity = false);
