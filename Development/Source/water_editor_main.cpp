...
void WaterEditor::load()
{
	...
	// Miscellaneous
	_gui.getGlobalScreen()->createTextfield("selectedWaterID", Vec2(0.0f, 0.85f), Vec2(0.5f, 0.1f), "", Vec3(1.0f));
...
void WaterEditor::unload()
{
	...
	// Miscellaneous
	_gui.getGlobalScreen()->deleteTextfield("selectedWaterID");
...
void WaterEditor::_loadGUI()
{
	...
	leftWindow->getScreen("waterEditorMenuMain")->createButton("add", Vec2(0.0f, positions[0]), Vec2(TW("Create Water"), CH), LVPC::BUTTON_COLOR, LVPC::BUTTON_HOVER_COLOR, "Create Water", LVPC::TEXT_COLOR, LVPC::TEXT_HOVER_COLOR);
