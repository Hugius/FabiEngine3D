...
void WorldEditor::initializeGUI()
{
	...
	_leftWindow->getScreen("waterEditorMenuOptions")->addButton("color", vec2(0.0f, 0.2625f), vec2(0.75f, 0.1f), LeftViewportController::buttonColor, LeftViewportController::buttonHoverColor, "Color", LeftViewportController::textColor, LeftViewportController::textHoverColor);
