...
void AabbEditor::_loadGUI()
{
	...
	leftWindow->getScreen("aabbEditorMenuChoice")->createButton("back", fvec2(0.0f, positions[1]), TEXT_SIZE("Go Back"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Go Back", TEXT_COLOR, TEXT_HOVER_COLOR, true);
}
