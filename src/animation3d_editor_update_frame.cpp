...
void Animation3dEditor::_updateFrameMenu()
{
	...
	if(screen->getId() == "animation3dEditorMenuFrame")
	{
		...
		{
			_gui->getOverlay()->openValueForm("speedX", "X", (speed.x * SPEED_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
			_gui->getOverlay()->openValueForm("speedY", "Y", (speed.y * SPEED_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
			_gui->getOverlay()->openValueForm("speedZ", "Z", (speed.z * SPEED_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
		}
		...
		{
			_gui->getOverlay()->openValueForm("rotationOriginX", "X", (rotationOrigin.x * ROTATION_ORIGIN_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
			_gui->getOverlay()->openValueForm("rotationOriginY", "Y", (rotationOrigin.y * ROTATION_ORIGIN_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
			_gui->getOverlay()->openValueForm("rotationOriginZ", "Z", (rotationOrigin.z * ROTATION_ORIGIN_FACTOR), fvec2(0.0f, 0.1f), 5, false, true, false);
		}
