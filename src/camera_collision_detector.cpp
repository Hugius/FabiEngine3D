...
const bool CameraCollisionDetector::checkX(const fvec3& aabbPosition, const fvec3& aabbSize, const fvec3& boxMiddle, const fvec3& boxMiddleChange, const Box& box) const
{
...
const bool CameraCollisionDetector::checkY(const fvec3& aabbPosition, const fvec3& aabbSize, const fvec3& boxMiddle, const fvec3& boxMiddleChange, const Box& box) const
{
...
const bool CameraCollisionDetector::checkZ(const fvec3& aabbPosition, const fvec3& aabbSize, const fvec3& boxMiddle, const fvec3& boxMiddleChange, const Box& box) const
{
...
const bool CameraCollisionDetector::_isInside(const fvec3& aabbPosition, const fvec3& aabbHalfSize, const fvec3& boxMiddle, const Box& box) const
{
	const auto left = box.getLeft();
	const auto right = box.getRight();
	const auto bottom = box.getBottom();
