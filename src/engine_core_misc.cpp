...
void EngineCore::_initialize()
{
	...
	const auto logoPath = (Tools::isApplicationExported() ? "logo\\logo.tga" : "engine\\assets\\image\\diffuse_map\\logo.tga");
	...
	const auto windowTitle = Tools::getWindowTitle();
	const auto windowSize = Tools::getWindowSize();
