...
public:
	...
	void quad_create(const string& ID, bool isCentered);
	void quad_delete(const string& ID);
	void quad_deleteAll();
	void quad_setVisible(const string& ID, bool value);
	void quad_setDiffuseMap(const string& ID, const string& value);
	void quad_setColor(const string& ID, fvec3 value);
	void quad_setTransparency(const string& ID, float value);
	void quad_setMinPosition(const string& ID, fvec2 value);
	void quad_setMaxPosition(const string& ID, fvec2 value);
	void quad_setPosition(const string& ID, fvec2 value);
	void quad_setRotation(const string& ID, float value);
	void quad_setSize(const string& ID, fvec2 value);
	void quad_move(const string& ID, fvec2 position);
	void quad_rotate(const string& ID, float rotation);
	void quad_scale(const string& ID, fvec2 size);
	...
	const fvec3 quad_getWireframeColor(const string& ID) const;
	const fvec3 quad_getColor(const string& ID) const;
	const fvec2 quad_getPosition(const string& ID) const;
