...
public:
	...
	void quad3d_setPosition(const string& ID, fvec3 value);
	void quad3d_setRotation(const string& ID, fvec3 value);
	void quad3d_setSize(const string& ID, fvec2 size);
	void quad3d_move(const string& ID, fvec3 change);
	void quad3d_rotate(const string& ID, fvec3 change);
	void quad3d_scale(const string& ID, fvec2 change);
	void quad3d_moveTo(const string& ID, fvec3 target, float speed);
	void quad3d_rotateTo(const string& ID, fvec3 target, float speed);
	void quad3d_scaleTo(const string& ID, fvec2 target, float speed);
	void quad3d_setColor(const string& ID, fvec3 value);
	void quad3d_setWireframeColor(const string& ID, fvec3 value);
	void quad3d_setUvMultiplier(const string& ID, fvec2 value);
	void quad3d_setUvOffset(const string& ID, fvec2 value);
	...
	void text3d_setSize(const string& ID, fvec2 size);
	void text3d_move(const string& ID, fvec3 change);
	void text3d_rotate(const string& ID, fvec3 change);
	void text3d_scale(const string& ID, fvec2 change);
	void text3d_moveTo(const string& ID, fvec3 target, float speed);
	void text3d_rotateTo(const string& ID, fvec3 target, float speed);
	void text3d_scaleTo(const string& ID, fvec2 target, float speed);
	void text3d_setColor(const string& ID, fvec3 value);
	void text3d_setWireframeColor(const string& ID, fvec3 value);
	...
	void quad2d_setColor(const string& ID, fvec3 value);
	void quad2d_setTransparency(const string& ID, float value);
	void quad2d_setMinPosition(const string& ID, fvec2 value);
	void quad2d_setMaxPosition(const string& ID, fvec2 value);
	void quad2d_setPosition(const string& ID, fvec2 value);
	void quad2d_setRotation(const string& ID, float value);
	void quad2d_setSize(const string& ID, fvec2 value);
	void quad2d_move(const string& ID, fvec2 position);
	void quad2d_rotate(const string& ID, float rotation);
	void quad2d_scale(const string& ID, fvec2 size);
	void quad2d_moveTo(const string& ID, fvec2 target, float speed);
	void quad2d_rotateTo(const string& ID, float target, float speed);
	void quad2d_scaleTo(const string& ID, fvec2 target, float speed);
	...
	void quad2d_setWireframeColor(const string& ID, fvec3 value);
	void quad2d_setUvMultiplier(const string& ID, fvec2 value);
	void quad2d_setUvOffset(const string& ID, fvec2 value);
	...
	void text2d_setMinPosition(const string& ID, fvec2 value);
	void text2d_setMaxPosition(const string& ID, fvec2 value);
	void text2d_setPosition(const string& ID, fvec2 value);
	void text2d_setRotation(const string& ID, float value);
	void text2d_setSize(const string& ID, fvec2 value);
	void text2d_move(const string& ID, fvec2 position);
	void text2d_rotate(const string& ID, float rotation);
	void text2d_scale(const string& ID, fvec2 size);
	void text2d_moveTo(const string& ID, fvec2 target, float speed);
	void text2d_rotateTo(const string& ID, float target, float speed);
	void text2d_scaleTo(const string& ID, fvec2 target, float speed);
	...
	void text2d_setWireframeColor(const string& ID, fvec3 value);
