...
public:
	...
	void model_startAnimation(const string & modelId, const string & animation3dId, int playCount);
	void model_pauseAnimation(const string & modelId, const string & animation3dId);
	void model_autopauseAnimation(const string & modelId, const string & animation3dId);
	void model_resumeAnimation(const string & modelId, const string & animation3dId);
	void model_stopAnimation(const string & modelId, const string & animation3dId);
	void model_setAnimationSpeedMultiplier(const string & modelId, const string & animation3dId, float value);
	void model_setAnimationFrameIndex(const string & modelId, const string & animation3dId, int value);

	const vector<string> model_getIds() const;
	const vector<string> model_getPartIds(const string & modelId) const;
	const vector<string> model_getAnimationIds(const string & modelId) const;
	...
	void quad3d_resumeAnimation(const string & quad3dId, const string & animation2dId);
	void quad3d_stopAnimation(const string & quad3dId, const string & animation2dId);
	void quad3d_setAnimationRowIndex(const string & quad3dId, const string & animation2dId, int value);
	...
	const bool quad3d_isAnimationStarted(const string & quad3dId, const string & animation2dId) const;
	const bool quad3d_isAnimationPaused(const string & quad3dId, const string & animation2dId) const;
	const bool quad3d_isAnimationAutopaused(const string & quad3dId, const string & animation2dId) const;
	...
	void aabb_setParentId(const string & aabbId, const string & value);
	void aabb_setParentType(const string & aabbId, AabbParentType value);
	...
	void quad2d_resumeAnimation(const string & quad2dId, const string & animation2dId);
	void quad2d_stopAnimation(const string & quad2dId, const string & animation2dId);
	void quad2d_setAnimationRowIndex(const string & animation2dId, const string & quad2dId, int value);
	...
	const int quad2d_getAnimationPlayCount(const string & quad2dId, const string & animation2dId) const;
	const int quad2d_getTextureRepeat(const string & quad2dId) const;
	const int quad2d_getAnimationRowIndex(const string & quad2dId, const string & animation2dId) const;
	...
	const bool quad2d_isAnimationStarted(const string & quad2dId, const string & animation2dId) const;
	const bool quad2d_isAnimationPaused(const string & quad2dId, const string & animation2dId) const;
	const bool quad2d_isAnimationAutopaused(const string & quad2dId, const string & animation2dId) const;
	...
	void sound3d_start(const string & sound3dId, int playCount);
