...
const vector<string> EngineInterface::text2d_getIds() const
{
	...
	for(const auto & [text2dId, text2d] : _core->getText2dManager()->getEntities())
	{
...
{
	return _core->getText2dManager()->getEntity(text2dId)->getFontMapPath();
}