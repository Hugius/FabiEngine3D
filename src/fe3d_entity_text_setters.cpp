...
void FabiEngine3D::text_setColor(const string& ID, Vec3 color)
{
...
void FabiEngine3D::text_setPosition(const string& ID, Vec2 position)
{
...
void FabiEngine3D::text_setSize(const string& ID, Vec2 size)
{
	_core->_textEntityManager.getEntity(ID)->setSize(size);
}

void FabiEngine3D::text_move(const string& ID, Vec2 position)
{
...
void FabiEngine3D::text_scale(const string& ID, Vec2 size)
{
	_core->_textEntityManager.getEntity(ID)->scale(size);
}

void FabiEngine3D::text_moveTo(const string& ID, Vec2 target, float speed)
{
...
void FabiEngine3D::text_scaleTo(const string& ID, Vec2 target, float speed)
{
	_core->_textEntityManager.getEntity(ID)->scaleTo(target, speed);
}

void FabiEngine3D::text_setMinPosition(const string& ID, Vec2 minPos)
{
	_core->_textEntityManager.getEntity(ID)->setMinPosition(minPos);
}

void FabiEngine3D::text_setMaxPosition(const string& ID, Vec2 maxPos)
{
