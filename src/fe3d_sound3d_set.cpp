...
void FabiEngine3D::sound3d_play(const string& ID, int playCount, unsigned int fadeMS, bool mustForcePlay)
{
	...
	_core->_sound3dPlayer.playSound(sound, playCount, fadeMS, mustForcePlay);
}
