...
private:
	...
	static inline const fvec3 CF_TITLE_QUAD_COLOR = fvec3(0.2f);
	static inline const fvec3 CF_TITLE_TEXT_COLOR = fvec3(1.0f);
	static inline const fvec3 CF_LIST_COLOR = fvec3(0.5f);
	static inline const fvec3 CF_DEFAULT_OPTION_QUAD_COLOR = fvec3(0.0f, 0.4f, 0.0f);
	...
	static inline const fvec3 CF_DEFAULT_CANCEL_QUAD_COLOR = fvec3(0.4f, 0.0f, 0.0f);
	...
	static inline const fvec3 VF_DEFAULT_CANCEL_QUAD_COLOR = fvec3(0.4f, 0.0f, 0.0f);
	...
	static inline const fvec3 AF_TITLE_QUAD_COLOR = fvec3(0.2f);
	static inline const fvec3 AF_TITLE_TEXT_COLOR = fvec3(1.0f);
	static inline const fvec3 AF_DEFAULT_LEFT_QUAD_COLOR = fvec3(0.0f, 0.4f, 0.0f);
	...
	static inline const fvec3 AF_DEFAULT_CANCEL_QUAD_COLOR = fvec3(0.4f, 0.0f, 0.0f);
	...
	static inline const fvec3 AF_DEFAULT_RIGHT_QUAD_COLOR = fvec3(0.0f, 0.4f, 0.0f);
