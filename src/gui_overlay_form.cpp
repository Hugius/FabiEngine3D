...
void GuiOverlay::_updateForms()
{
	...
	{
		if(!getChoiceFormOptionId().empty() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseChoiceForm = true;
		}

		if(getButton("choice_form_cancel")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseChoiceForm = true;
		}
	...
	{
		if(getButton("value_form_enter")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseValueForm = true;
		}

		if(getButton("value_form_cancel")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseValueForm = true;
		}

		if(_fe3d->input_isKeyboardPressed(KeyType::KEY_ENTER))
		{
			_mustCloseValueForm = true;
		}
	...
	{
		if(getButton("answer_form_left")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseAnswerForm = true;
		}

		if(getButton("answer_form_cancel")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseAnswerForm = true;
		}

		if(getButton("answer_form_right")->isHovered() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
		{
			_mustCloseAnswerForm = true;
		}
...
const bool GuiOverlay::isChoiceFormConfirmed() const
{
	...
	if(!getScrollingList("choice_form_list")->getHoveredOptionId().empty() && _fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT))
	{
		return true;
	}
