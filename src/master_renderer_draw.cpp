...
void MasterRenderer::_renderDebugScreens()
{
	...
	sceneQuad->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, 0.666f, 0.666f, 0.666f, true));
	...
	shadowQuad->setVertexBuffer(make_shared<VertexBuffer>(0.0f, 0.666f, 0.666f, 0.666f, true));
	...
	bloomQuad->setVertexBuffer(make_shared<VertexBuffer>(0.666f, 0.666f, 0.666f, 0.666f, true));
	...
	planarReflectionQuad->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, 0.0f, 0.666f, 0.666f, true));
	...
	waterReflectionQuad->setVertexBuffer(make_shared<VertexBuffer>(0.0f, 0.0f, 0.666f, 0.666f, true));
	...
	waterRefractionQuad->setVertexBuffer(make_shared<VertexBuffer>(0.666f, 0.0f, 0.666f, 0.666f, true));
	...
	depthQuad->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, -0.666f, 0.666f, 0.666f, true));
	...
	dofQuad->setVertexBuffer(make_shared<VertexBuffer>(0.0f, -0.666f, 0.666f, 0.666f, true));
	...
	motionBlurQuad->setVertexBuffer(make_shared<VertexBuffer>(0.666f, -0.666f, 0.666f, 0.666f, true));
	...
	worldText->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, 0.4f, calcTextWidth("World Render"), charHeight, true));
	...
	shadowText->setVertexBuffer(make_shared<VertexBuffer>(0.0f, 0.4f, calcTextWidth("Shadow Render"), charHeight, true));
	...
	bloomText->setVertexBuffer(make_shared<VertexBuffer>(0.666f, 0.4f, calcTextWidth("Bloom Render"), charHeight, true));
	...
	planarReflectionText->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, -0.26f, calcTextWidth("Planar Reflection Render"), charHeight, true));
	...
	waterReflectionText->setVertexBuffer(make_shared<VertexBuffer>(0.0f, -0.26f, calcTextWidth("Water Reflection Render"), charHeight, true));
	...
	waterRefractionText->setVertexBuffer(make_shared<VertexBuffer>(0.666f, -0.26f, calcTextWidth("Water Refraction Render"), charHeight, true));
	...
	depthText->setVertexBuffer(make_shared<VertexBuffer>(-0.666f, -0.92f, calcTextWidth("Depth Render"), charHeight, true));
	...
	dofText->setVertexBuffer(make_shared<VertexBuffer>(0.0f, -0.92f, calcTextWidth("DOF Render"), charHeight, true));
	...
	motionBlurText->setVertexBuffer(make_shared<VertexBuffer>(0.666f, -0.92f, calcTextWidth("Motion Blur Render"), charHeight, true));
