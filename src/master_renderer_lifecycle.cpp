...
MasterRenderer::MasterRenderer()
{
	...
	_skyEntityColorShaderBuffer = make_shared<ShaderBuffer>("sky_color_shader.vert", "sky_color_shader.frag");
	_terrainEntityColorShaderBuffer = make_shared<ShaderBuffer>("terrain_color_shader.vert", "terrain_color_shader.frag");
	_terrainEntityDepthShaderBuffer = make_shared<ShaderBuffer>("terrain_depth_shader.vert", "terrain_depth_shader.frag");
	_waterEntityColorShaderBuffer = make_shared<ShaderBuffer>("water_color_shader.vert", "water_color_shader.frag");
	_waterEntityDepthShaderBuffer = make_shared<ShaderBuffer>("water_depth_shader.vert", "water_depth_shader.frag");
	_modelEntityColorShaderBuffer = make_shared<ShaderBuffer>("model_color_shader.vert", "model_color_shader.frag");
	_modelEntityDepthShaderBuffer = make_shared<ShaderBuffer>("model_depth_shader.vert", "model_depth_shader.frag");
	_modelEntityShadowShaderBuffer = make_shared<ShaderBuffer>("model_shadow_shader.vert", "model_shadow_shader.frag");
	_quad3dEntityColorShaderBuffer = make_shared<ShaderBuffer>("quad3d_color_shader.vert", "quad3d_color_shader.frag");
	_quad3dEntityDepthShaderBuffer = make_shared<ShaderBuffer>("quad3d_depth_shader.vert", "quad3d_depth_shader.frag");
	_quad3dEntityShadowShaderBuffer = make_shared<ShaderBuffer>("quad3d_shadow_shader.vert", "quad3d_shadow_shader.frag");
	_aabbEntityColorShaderBuffer = make_shared<ShaderBuffer>("aabb_color_shader.vert", "aabb_color_shader.frag");
	_aabbEntityDepthShaderBuffer = make_shared<ShaderBuffer>("aabb_depth_shader.vert", "aabb_depth_shader.frag");
	_quad2dEntityColorShaderBuffer = make_shared<ShaderBuffer>("quad2d_color_shader.vert", "quad2d_color_shader.frag");
	...
	_skyColorRenderer->inject(_skyEntityColorShaderBuffer);
	_terrainColorRenderer->inject(_terrainEntityColorShaderBuffer);
	_terrainDepthRenderer->inject(_terrainEntityDepthShaderBuffer);
	_waterColorRenderer->inject(_waterEntityColorShaderBuffer);
	_waterDepthRenderer->inject(_waterEntityDepthShaderBuffer);
	_modelColorRenderer->inject(_modelEntityColorShaderBuffer);
	_modelDepthRenderer->inject(_modelEntityDepthShaderBuffer);
	_modelShadowRenderer->inject(_modelEntityShadowShaderBuffer);
	_quad3dColorRenderer->inject(_quad3dEntityColorShaderBuffer);
	_quad3dDepthRenderer->inject(_quad3dEntityDepthShaderBuffer);
	_quad3dShadowRenderer->inject(_quad3dEntityShadowShaderBuffer);
	_aabbColorRenderer->inject(_aabbEntityColorShaderBuffer);
	_aabbDepthRenderer->inject(_aabbEntityDepthShaderBuffer);
	_quad2dColorRenderer->inject(_quad2dEntityColorShaderBuffer);
