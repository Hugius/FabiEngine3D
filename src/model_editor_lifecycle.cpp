...
void ModelEditor::_loadGUI()
{
	...
	leftWindow->getScreen("modelEditorMenuLighting")->createButton("reflectionType", fvec2(0.0f, positions[6]), TEXT_SIZE("Type: CUBE"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Type: CUBE", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	...
	leftWindow->getScreen("modelEditorMenuLighting")->createButton("isRefractive", fvec2(0.0f, positions[8]), TEXT_SIZE("Refractive: OFF"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Refractive: OFF", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	leftWindow->getScreen("modelEditorMenuLighting")->createButton("refractionType", fvec2(0.0f, positions[9]), TEXT_SIZE("Type: CUBE"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Type: CUBE", TEXT_COLOR, TEXT_HOVER_COLOR, true);
