...
void ModelEditor::_loadGUI()
{
	...
	leftWindow->getScreen("modelEditorMenuLighting")->createButton("refractionType", fvec2(0.0f, positions[9]), TEXT_SIZE("Type: NONE"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Type: NONE", TEXT_COLOR, TEXT_HOVER_COLOR, true);
