...
void ModelEditor::_updateChoiceMenu()
{
	...
	if(screen->getId() == "modelEditorMenuChoice")
	{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("texturing")->isHovered())
		{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("aabb")->isHovered())
		{
