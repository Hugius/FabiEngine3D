...
void PointlightEditor::_updateMainMenu()
{
	...
	if(screen->getId() == "pointlightEditorMenuMain")
	{
		...
		{
			_gui->getOverlay()->openValueForm("createPointlight", "Create Pointlight", "", VALUE_FORM_POSITION, VALUE_FORM_SIZE, true, true, false);
		}
...
void PointlightEditor::_updateChoiceMenu()
{
	...
	if(screen->getId() == "pointlightEditorMenuChoice")
	{
		...
		{
			_gui->getOverlay()->openValueForm("radiusX", "X", (radius.x * RADIUS_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
			_gui->getOverlay()->openValueForm("radiusY", "Y", (radius.y * RADIUS_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
			_gui->getOverlay()->openValueForm("radiusZ", "Z", (radius.z * RADIUS_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
		}
		...
		{
			_gui->getOverlay()->openValueForm("intensity", "X", (intensity * INTENSITY_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
		}
