...
void Quad3dEditor::_updateMiscellaneousMenu()
{
	...
	if(screen->getId() == "quad3dEditorMenuMiscellaneous")
	{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("isFacingCameraHorizontally")->isHovered())
		{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("isFacingCameraVertically")->isHovered())
		{
