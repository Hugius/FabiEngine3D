...
private:
	...
	const bool _executeFe3dInputGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dCameraSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dCameraGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dRaycastSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dRaycastGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dCollisionSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dCollisionGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dSkySetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dSkyGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dTerrainSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dTerrainGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dWaterSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dWaterGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dModelSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dModelGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dBillboardSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dBillboardGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dAabbSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dAabbGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dPointlightSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dPointlightGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dSpotlightSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dSpotlightGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dReflectionSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dReflectionGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dImageSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	...
	const bool _executeFe3dSound3dGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dLightingSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	...
	const bool _executeFe3dWorldGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dServerSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dServerGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dClientSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dClientGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dMiscSetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
	const bool _executeFe3dMiscGetter(const string& functionName, vector<ScriptValue>& arguments, vector<ScriptValue>& returnValues);
