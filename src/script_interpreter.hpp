...
private:
	...
	static inline const unordered_map<string, KeyType> KEYBOARD_KEYS =
	{
		...
		{"KEY_Y", KeyType::KEY_Y},
		{"KEY_Z", KeyType::KEY_Z},
		{"KEY_NUMPAD0", KeyType::KEY_NUMPAD0},
		{"KEY_NUMPAD1", KeyType::KEY_NUMPAD1},
		{"KEY_NUMPAD2", KeyType::KEY_NUMPAD2},
		{"KEY_NUMPAD3", KeyType::KEY_NUMPAD3},
		{"KEY_NUMPAD4", KeyType::KEY_NUMPAD4},
		{"KEY_NUMPAD5", KeyType::KEY_NUMPAD5},
		{"KEY_NUMPAD6", KeyType::KEY_NUMPAD6},
		{"KEY_NUMPAD7", KeyType::KEY_NUMPAD7},
		{"KEY_NUMPAD8", KeyType::KEY_NUMPAD8},
		{"KEY_NUMPAD9", KeyType::KEY_NUMPAD9},
		{"KEY_MULTIPLY", KeyType::KEY_MULTIPLY},
		{"KEY_ADD", KeyType::KEY_ADD},
		{"KEY_SUBTRACT", KeyType::KEY_SUBTRACT},
		{"KEY_DECIMAL", KeyType::KEY_DECIMAL},
		{"KEY_DIVIDE", KeyType::KEY_DIVIDE},
