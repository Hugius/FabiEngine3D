...
private:
	...
	static inline const string DEFINE_KEYWORD = "DEF";
	static inline const string ALTER_KEYWORD = "ALT";
	static inline const string GLOBAL_KEYWORD = "GLB";
	static inline const string FINAL_KEYWORD = "FIN";
