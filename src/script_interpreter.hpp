...
private:
	...
	const bool _validateFe3dSky(const string & skyId, bool isTemplate);
	const bool _validateFe3dTerrain(const string & terrainId, bool isTemplate);
	...
	const bool _validateFe3dAabb(const string & aabbId);
	...
	const bool _validateFe3dPointlight(const string & pointlightId);
