	...
	else if(functionName == "fe3d:quad3d_set_animation2d_row_index")
	{
		...
		if(_validateArgumentCount(args, static_cast<int>(types.size())) && _validateArgumentTypes(args, types))
		{
			if(_validateFe3dQuad3d(args[0]->getString(), false) && _validateFe3dAnimation2d(args[1]->getString()))
			{
				...
				_fe3d->quad3d_setAnimation2dRowIndex(args[0]->getString(), args[1]->getString(), args[2]->getInteger());
	...
	else if(functionName == "fe3d:quad3d_set_animation2d_column_index")
	{
		...
		if(_validateArgumentCount(args, static_cast<int>(types.size())) && _validateArgumentTypes(args, types))
		{
			if(_validateFe3dQuad3d(args[0]->getString(), false) && _validateFe3dAnimation2d(args[1]->getString()))
			{
				...
				_fe3d->quad3d_setAnimation2dColumnIndex(args[0]->getString(), args[1]->getString(), args[2]->getInteger());
	...
	else if(functionName == "fe3d:quad3d_set_animation2d_interval_multiplier")
	{
		...
		if(_validateArgumentCount(args, static_cast<int>(types.size())) && _validateArgumentTypes(args, types))
		{
			if(_validateFe3dQuad3d(args[0]->getString(), false) && _validateFe3dAnimation2d(args[1]->getString()))
			{
				...
				_fe3d->quad3d_setAnimation2dIntervalMultiplier(args[0]->getString(), args[1]->getString(), args[2]->getInteger());
	...
	else if(functionName == "fe3d:quad3d_set_animation2d_interval_divider")
	{
		...
		if(_validateArgumentCount(args, static_cast<int>(types.size())) && _validateArgumentTypes(args, types))
		{
			if(_validateFe3dQuad3d(args[0]->getString(), false) && _validateFe3dAnimation2d(args[1]->getString()))
			{
				...
				_fe3d->quad3d_setAnimation2dIntervalDivider(args[0]->getString(), args[1]->getString(), args[2]->getInteger());
