...
void SkyEditor::_updateTexturingMenu()
{
	...
	if(screen->getId() == "skyEditorMenuTexturing")
	{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("leftMap")->isHovered())
		{
			...
			const auto targetDirectoryPath = ("projects\\" + getCurrentProjectId() + "\\assets\\image\\entity\\sky\\cube_map\\");
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("rightMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("bottomMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("topMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("backMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("frontMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
