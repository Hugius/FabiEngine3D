...
private:
	...
	static inline const string SOUND2D_TEXT_ID = "sound2d_id";

	static inline const fvec3 STATUS_QUAD3D_POSITION = fvec3(0.0f, 0.0f, -1.5f);

	static inline const fvec2 SOUND2D_TEXT_POSITION = fvec2(0.0f, 0.85f);
	static inline const fvec2 SOUND2D_TEXT_SIZE = fvec2(0.025f, 0.1f);
