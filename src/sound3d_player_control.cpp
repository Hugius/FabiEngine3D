...
void Sound3dPlayer::startSound3d(const string & sound3dId, int playCount, int startTime)
{
	...
	const auto startIndex = static_cast<int>(((waveBuffer->getFormat()->nSamplesPerSec / 1000) * startTime) * 2);
