...
void SoundEditor::_updateMainMenu()
{
	...
	if(screen->getID() == "soundEditorMenuMain")
	{
		...
		{
			_gui.getGlobalScreen()->createValueForm("soundCreate", "Create Sound", "", fvec2(0.0f, 0.1f), fvec2(0.5f, 0.1f), fvec2(0.0f, 0.1f));
		...
		else if(_fe3d.input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("edit")->isHovered())
		{
			...
			_gui.getGlobalScreen()->createChoiceForm("soundList", "Edit Sound", fvec2(0.0f, 0.1f), IDs);
		...
		else if(_fe3d.input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("delete")->isHovered())
		{
			...
			_gui.getGlobalScreen()->createChoiceForm("soundList", "Delete Sound", fvec2(0.0f, 0.1f), IDs);
			_isChoosingSound = true;
...
void SoundEditor::_updateChoiceMenu()
{
	...
	if(screen->getID() == "soundEditorMenuChoice")
	{
		...
		{
			_fe3d.sound2d_play(_currentSoundID, 0, 0, false);
		}
