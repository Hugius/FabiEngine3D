...
void TerrainEditor::_updateBlendMapMenu()
{
	...
	if(screen->getId() == "terrainEditorMenuBlendTexturing")
	{
		...
		else if(_fe3d->input_isMousePressed(MouseButton::BUTTON_LEFT) && screen->getButton("blendMap")->isHovered())
		{
			...
			const auto targetDirectoryPath = ("projects\\" + getCurrentProjectId() + "\\assets\\image\\entity\\terrain\\blend_map\\");
