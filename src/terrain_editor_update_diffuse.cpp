...
void TerrainEditor::_updateDiffuseMapMenu()
{
	...
	if(screen->getId() == "terrainEditorMenuDiffuseTexturing")
	{
		...
		else if(_fe3d->input_isMousePressed(MouseButton::BUTTON_LEFT) && screen->getButton("redDiffuseMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(MouseButton::BUTTON_LEFT) && screen->getButton("greenDiffuseMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
		...
		else if(_fe3d->input_isMousePressed(MouseButton::BUTTON_LEFT) && screen->getButton("blueDiffuseMap")->isHovered())
		{
			if(getCurrentProjectId().empty())
			{
				abort();
