...
void Text2dEditor::_updateMainMenu()
{
	...
	if(screen->getId() == "text2dEditorMenuMain")
	{
		...
		{
			_gui->getOverlay()->enableValueForm("textCreate", "Create Text", "", fvec2(0.0f, 0.1f), fvec2(0.5f, 0.1f), fvec2(0.0f, 0.1f));
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("edit")->isHovered())
		{
			...
			_gui->getOverlay()->enableChoiceForm("textList", "Edit Text", fvec2(-0.5f, 0.1f), ids);
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("delete")->isHovered())
		{
			...
			_gui->getOverlay()->enableChoiceForm("textList", "Delete Text", fvec2(-0.5f, 0.1f), ids);
			_isChoosingText = true;
