...
void Text3dEditor::_updateMainMenu()
{
	...
	if(screen->getId() == "text3dEditorMenuMain")
	{
		...
		{
			_gui->getOverlay()->openValueForm("text3dCreate", "Create Text3D", "", fvec2(0.0f, 0.1f), fvec2(0.5f, 0.1f), fvec2(0.0f, 0.1f));
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("edit")->isHovered())
		{
			...
			_gui->getOverlay()->openChoiceForm("text3dList", "Edit Text3D", fvec2(-0.5f, 0.1f), ids);
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("delete")->isHovered())
		{
			...
			_gui->getOverlay()->openChoiceForm("text3dList", "Delete Text3D", fvec2(-0.5f, 0.1f), ids);
			_isChoosingText3d = true;
