...
void Text3dEditor::_updateMiscellaneousMenu()
{
	...
	if(screen->getId() == "text3dEditorMenuMiscellaneous")
	{
		...
		{
			_gui->getOverlay()->enableValueForm("sizeX", "X", (size.x * 100.0f), fvec2(-0.15f, 0.1f), fvec2(0.15f, 0.1f), fvec2(0.0f, 0.1f));
			_gui->getOverlay()->enableValueForm("sizeY", "Y", (size.y * 100.0f), fvec2(0.15f, 0.1f), fvec2(0.15f, 0.1f), fvec2(0.0f, 0.1f));
		}
