...
void TopViewportController::_updateProjectCreating()
{
	...
	{
		if((_gui->getOverlay()->getValueFormId() == "projectId") && _gui->getOverlay()->isValueFormConfirmed())
		{
...
void TopViewportController::_updateProjectLoading()
{
	...
	{
		if((_gui->getOverlay()->getChoiceFormId() == "projectList") && _gui->getOverlay()->isChoiceFormConfirmed())
		{
			const auto rootPath = Tools::getRootDirectoryPath();
