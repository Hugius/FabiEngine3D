...
private:
	...
	static inline constexpr float CAMERA_DISTANCE_SPEED = 2.0f;
	...
	static inline constexpr float RIPPLE_SPEED_FACTOR = 10000.0f;
	static inline constexpr float WAVE_SPEED_FACTOR = 10000.0f;
