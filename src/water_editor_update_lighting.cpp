...
void WaterEditor::_updateLightingMenu()
{
	...
	if(screen->getId() == "waterEditorMenuLighting")
	{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("isRefractive")->isHovered())
		{
		...
		else if(_fe3d->input_isMousePressed(ButtonType::BUTTON_LEFT) && screen->getButton("isEdged")->isHovered())
		{
