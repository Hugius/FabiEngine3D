...
void WaterEditor::_updateMainMenu()
{
	...
	if(screen->getId() == "waterEditorMenuMain")
	{
		...
		{
			_gui->getOverlay()->enableValueForm("waterCreate", "Create Water", "", fvec2(0.0f, 0.1f), fvec2(0.5f, 0.1f), fvec2(0.0f, 0.1f));
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("edit")->isHovered())
		{
			...
			_gui->getOverlay()->enableChoiceForm("waterList", "Edit Water", fvec2(-0.5f, 0.1f), ids);
		...
		else if(_fe3d->input_isMousePressed(InputType::MOUSE_BUTTON_LEFT) && screen->getButton("delete")->isHovered())
		{
			...
			_gui->getOverlay()->enableChoiceForm("waterList", "Delete Water", fvec2(-0.5f, 0.1f), ids);
			_isChoosingWater = true;
