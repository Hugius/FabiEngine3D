...
private:
	...
	static inline constexpr string TEMPLATE_LAMP_ID = "@@template_lamp";
	static inline constexpr string TEMPLATE_TORCH_ID = "@@template_torch";
	static inline constexpr string TEMPLATE_CAMERA_ID = "@@template_camera";
	static inline constexpr string TEMPLATE_SPEAKER_ID = "@@template_speaker";
	static inline constexpr string LAMP_MODEL_PATH = "engine\\assets\\mesh\\lamp.obj";
	static inline constexpr string TORCH_MODEL_PATH = "engine\\assets\\mesh\\torch.obj";
	static inline constexpr string CAMERA_MODEL_PATH = "engine\\assets\\mesh\\camera.obj";
	static inline constexpr string SPEAKER_MODEL_PATH = "engine\\assets\\mesh\\speaker.obj";
	...
	static inline constexpr fvec3 DEFAULT_LAMP_SIZE = fvec3(1.0f, 1.0f, 1.0f);
	static inline constexpr fvec3 DEFAULT_LAMP_AABB_SIZE = fvec3(0.6f, 1.0f, 0.6f);
	static inline constexpr fvec3 DEFAULT_TORCH_ROTATION = fvec3(0.0f, 0.0f, -90.0f);
	static inline constexpr fvec3 DEFAULT_TORCH_SIZE = fvec3(1.0f, 1.0f, 1.0f);
	static inline constexpr fvec3 DEFAULT_TORCH_AABB_SIZE = fvec3(1.0f, 0.25f, 0.3f);
	static inline constexpr fvec3 DEFAULT_CAMERA_SIZE = fvec3(1.0f, 1.0f, 1.0f);
	static inline constexpr fvec3 DEFAULT_CAMERA_AABB_SIZE = fvec3(1.0f, 1.0f, 1.0f);
	static inline constexpr fvec3 DEFAULT_SPEAKER_SIZE = fvec3(1.0f, 1.0f, 1.0f);
	static inline constexpr fvec3 DEFAULT_SPEAKER_AABB_SIZE = fvec3(1.05f, 1.05f, 0.9f);
	static inline constexpr fvec3 MODEL_TERRAIN_OFFSET = fvec3(0.0f, 0.0f, 0.0f);
	static inline constexpr fvec3 QUAD3D_TERRAIN_OFFSET = fvec3(0.0f, 0.0f, 0.0f);
	static inline constexpr fvec3 TEXT3D_TERRAIN_OFFSET = fvec3(0.0f, 0.0f, 0.0f);
	static inline constexpr fvec3 POINTLIGHT_TERRAIN_OFFSET = fvec3(0.0f, 1.5f, 0.0f);
	static inline constexpr fvec3 SPOTLIGHT_TERRAIN_OFFSET = fvec3(0.0f, 1.5f, 0.0f);
	static inline constexpr fvec3 REFLECTION_TERRAIN_OFFSET = fvec3(0.0f, 0.5f, 0.0f);
	static inline constexpr fvec3 SOUND_TERRAIN_OFFSET = fvec3(0.0f, 0.5f, 0.0f);
	static inline constexpr fvec3 LAMP_OFFSET = fvec3(0.0f, 0.5f, 0.0f);
	static inline constexpr fvec3 CAMERA_OFFSET = fvec3(0.0f, 0.5f, 0.0f);
	static inline constexpr fvec3 SPEAKER_OFFSET = fvec3(0.0f, 0.5f, 0.0f);
