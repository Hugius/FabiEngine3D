...
private:
	...
	map<string, string> _loadedQuad3dIDs;
	map<string, string> _outsideLoadedQuad3dIDs;
	...
	vector<string> _customWorldQuad3dIDs;
	...
	static inline const float MODEL_POSITION_DIVIDER = 100.0f;
	static inline const float MODEL_ROTATION_SPEED = 0.5f;
	static inline const float MODEL_SIZE_DIVIDER = 100.0f;
	static inline const float MODEL_SIZE_MULTIPLIER = 100.0f;
	static inline const float MODEL_HIGHLIGHT_SPEED = 0.025f;
	static inline const float BILLBOARD_POSITION_DIVIDER = 100.0f;
	static inline const float BILLBOARD_ROTATION_SPEED = 0.5f;
	static inline const float BILLBOARD_SIZE_DIVIDER = 100.0f;
	...
	static inline const float POINTLIGHT_INTENSITY_SPEED = 0.1f;
	static inline const float SPOTLIGHT_POSITION_DIVIDER = 100.0f;
	static inline const float SPOTLIGHT_COLOR_SPEED = 0.005f;
	static inline const float SPOTLIGHT_YAW_SPEED = 0.5f;
	static inline const float SPOTLIGHT_PITCH_SPEED = 0.5f;
	static inline const float SPOTLIGHT_INTENSITY_SPEED = 0.1f;
	static inline const float SPOTLIGHT_ANGLE_SPEED = 0.1f;
	static inline const float SPOTLIGHT_DISTANCE_DIVIDER = 100.0f;
	static inline const float REFLECTION_POSITION_DIVIDER = 100.0f;
	static inline const float SOUND_POSITION_DIVIDER = 100.0f;
	static inline const float SOUND_DISTANCE_DIVIDER = 100.0f;
	static inline const float SOUND_VOLUME_MULTIPLIER = 100.0f;
	static inline const float SOUND_VOLUME_SPEED = 0.01f;
