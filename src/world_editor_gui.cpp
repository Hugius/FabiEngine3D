...
void WorldEditor::_loadGUI()
{
	...
	leftWindow->getScreen("pointlightPropertiesMenu")->createTextField("x", fvec2(0.0f, 0.435f), fvec2(0.25f, 0.1f), "X", fvec3(1.0f), true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createTextField("y", fvec2(0.0f, 0.21f), fvec2(0.25f, 0.1f), "Y", fvec3(1.0f), true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createTextField("z", fvec2(0.0f, -0.015f), fvec2(0.25f, 0.1f), "Z", fvec3(1.0f), true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createButton("xPlus", fvec2(0.75f, 0.325f), fvec2(0.5f, 0.15f), "plus.tga", fvec3(1.0f), fvec3(0.25f), "", fvec3(0.0f), fvec3(0.0f), true);
	...
	leftWindow->getScreen("pointlightPropertiesMenu")->createButton("zPlus", fvec2(0.75f, -0.125f), fvec2(0.5f, 0.15f), "plus.tga", fvec3(1.0f), fvec3(0.25f), "", fvec3(0.0f), fvec3(0.0f), true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createButton("xMinus", fvec2(-0.75f, 0.325f), fvec2(0.5f, 0.15f), "minus.tga", fvec3(1.0f), fvec3(0.25f), "", fvec3(0.0f), fvec3(0.0f), true);
	...
	leftWindow->getScreen("pointlightPropertiesMenu")->createButton("zMinus", fvec2(-0.75f, -0.125f), fvec2(0.5f, 0.15f), "minus.tga", fvec3(1.0f), fvec3(0.25f), "", fvec3(0.0f), fvec3(0.0f), true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createInputBox("x", fvec2(0.0f, 0.325f), fvec2(1.0f, 0.1f), fvec3(0.25f), fvec3(0.75f), fvec3(1.0f), fvec3(0.0f), 7, false, true, false, true);
	...
	leftWindow->getScreen("pointlightPropertiesMenu")->createInputBox("z", fvec2(0.0f, -0.125f), fvec2(1.0f, 0.1f), fvec3(0.25f), fvec3(0.75f), fvec3(1.0f), fvec3(0.0f), 7, false, true, false, true);
	leftWindow->getScreen("pointlightPropertiesMenu")->createButton("delete", fvec2(0.0f, -0.275f), fvec2(0.75f, 0.1f), "", fvec3(0.75f, 0.0f, 0.0f), fvec3(1.0f, 0.25f, 0.25f), "Delete", TEXT_COLOR, TEXT_HOVER_COLOR, true);
