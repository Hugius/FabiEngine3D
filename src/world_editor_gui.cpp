...
void WorldEditor::_loadGUI()
{
	...
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("isFollowingCameraX", fvec2(0.0f, POSITIONS(13)[6]), TEXT_SIZE("Follow Cam X: OFF"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Follow Cam X: OFF", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("isFollowingCameraY", fvec2(0.0f, POSITIONS(13)[7]), TEXT_SIZE("Follow Cam Y: OFF"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Follow Cam Y: OFF", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("isFollowingCameraZ", fvec2(0.0f, POSITIONS(13)[8]), TEXT_SIZE("Follow Cam Z: OFF"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Follow Cam Z: OFF", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("interval", fvec2(0.0f, POSITIONS(13)[9]), TEXT_SIZE("Interval"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Interval", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("pcfCount", fvec2(0.0f, POSITIONS(13)[10]), TEXT_SIZE("PCF Count"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "PCF Count", TEXT_COLOR, TEXT_HOVER_COLOR, true);
	rightWindow->getScreen("worldEditorMenuSettingsGraphicsShadows")->createButton("quality", fvec2(0.0f, POSITIONS(13)[11]), TEXT_SIZE("Quality"), "", BUTTON_COLOR, BUTTON_HOVER_COLOR, "Quality", TEXT_COLOR, TEXT_HOVER_COLOR, true);
