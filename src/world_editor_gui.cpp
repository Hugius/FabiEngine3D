...
void WorldEditor::_loadGUI()
{
	...
	rightWindow->getScreen("modelPropertiesMenu")->createInputBox("x", fvec2(0.0f, 0.025f), fvec2(1.0f, 0.1f), fvec3(0.25f), fvec3(0.75f), fvec3(1.0f), fvec3(0.0f), 7, 0, 1, 1, 1, true);
