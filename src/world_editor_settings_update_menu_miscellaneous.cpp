...
void WorldEditor::_updateFogSettingsMenu()
{
	...
	if(screen->getId() == "worldEditorMenuSettingsFog")
	{
		...
		{
			_gui->getOverlay()->openValueForm("colorR", "Red", (color.r * FOG_COLOR_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
			_gui->getOverlay()->openValueForm("colorG", "Green", (color.g * FOG_COLOR_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
			_gui->getOverlay()->openValueForm("colorB", "Blue", (color.b * FOG_COLOR_FACTOR), VALUE_FORM_POSITION, VALUE_FORM_SIZE, false, true, false);
		}
		...
		else if((_gui->getOverlay()->getValueFormId() == "colorR") && _gui->getOverlay()->isValueFormConfirmed())
		{
			...
			_fe3d->graphics_setFogColor(fvec3((value / FOG_COLOR_FACTOR), color.g, color.b));
		}
		else if((_gui->getOverlay()->getValueFormId() == "colorG") && _gui->getOverlay()->isValueFormConfirmed())
		{
			...
			_fe3d->graphics_setFogColor(fvec3(color.r, (value / FOG_COLOR_FACTOR), color.b));
		}
		else if((_gui->getOverlay()->getValueFormId() == "colorB") && _gui->getOverlay()->isValueFormConfirmed())
		{
			...
			_fe3d->graphics_setFogColor(fvec3(color.r, color.g, (value / FOG_COLOR_FACTOR)));
		}
